...
The page is **standalone's** (``drive/dashboard_page.PAGE``) — this module used to carry its own copy, which
drifted from the polished one. ``runtime/rl_monitor.py`` re-shapes env_driver's snapshots into the schema that
