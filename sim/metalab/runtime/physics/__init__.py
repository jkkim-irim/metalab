...
Contact-level data has no shared representation across engines — newton's lives in warp arrays, genesis'
in ``quadrants`` fields — so here the FORMULA is shared and the kernels are written twice, against the
same oracle.
"""
