...
Reads the four CSVs written by ``sim/metalab/tools/standalone.py`` in a run dir:
...
Also runnable manually:
  python -m sim.metalab.dashboard.hand_log_plot <run_dir> [--joint R_Index_PIP] [--fingertip ...] [--dpi 400] [--out PATH]
