"""Standalone trajectory control + telemetry server (mirrors ``dashboard/telemetry.py``).
...
- ``GET  /``         → the trajectory control + live-plot dashboard page (``dashboard/page.PAGE`` —
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_GET(self):
                if self.path == "/" or self.path.startswith("/index"):
                    self._send(PAGE.encode(), "text/html; charset=utf-8")   # dashboard/page.py
