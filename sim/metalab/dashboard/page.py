...
prefers-color-scheme). Plotting mirrors dashboard/telemetry.py (canvas, per-series toggles, legend,
...
# preview can render the LAST run's real channel set with no engine env. Written by tools/standalone.py,
