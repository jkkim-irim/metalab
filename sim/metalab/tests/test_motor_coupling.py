...
_FINGER_JSON = _REPO / "sim/metalab/drive/motor2joint/mj_mapping/finger.json"   # shared firmware J2M
_THUMB_JSON = _REPO / "sim/metalab/drive/motor2joint/mj_mapping/thumb.json"      # shared thumb J2M
_PARAMS_JSON = _REPO / "sim/metalab/drive/motor2joint/robot_model.json"
_WRIST_JSON = _REPO / "sim/metalab/drive/motor2joint/mj_mapping/wrist.json"      # shared wrist J2M
_ELBOW_JSON = _REPO / "sim/metalab/drive/motor2joint/mj_mapping/elbow.json"      # shared elbow J2M
_SHOULDER_JSON = _REPO / "sim/metalab/drive/motor2joint/mj_mapping/shoulder.json"  # shared shoulder J2M
...
def _coupled_pd_oracle_check(group_name, joints, model_file, poly, k_phi, k_d, seed, gain_slice=None):
    ...
    from sim.metalab.drive.motor2joint.motor_coupling import MotorCoupledPDHand, load_hand_group
    wp.init()
...
def _coupled_pd_arm_oracle_check(joints, json_path, arm_slice, seed):
    ...
    from sim.metalab.drive.motor2joint.motor_coupling import MotorCoupledPDArm, load_arm_group
    wp.init()
...
def test_shared_finger_map_backs_multiple_groups():
    ...
    try:
        from sim.metalab.drive.motor2joint.motor_coupling import load_hand_group
    except ModuleNotFoundError:
